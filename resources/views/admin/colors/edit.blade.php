        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('admin.color.update', $color->id) }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                                <input type="checkbox" name="status" class="btn-check" id="status" {{ $color->status == 1 ? 'checked' : '' }}
                                    autocomplete="off">
